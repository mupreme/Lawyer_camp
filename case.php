							...
							<div class="container">
								<form class="cusform" action="case_saving.php" method="post">
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" name="contact" id="contact" value="<?php echo $row["contact_number"]; ?>">
									</div>
									
									
									<div class="form-row"><label class="font-weight-bold" for="edu"><small>Put Your case description here</small></label></div>
									<div class="form-row">
									...
									<button type="submit" class="btn btn-info">Upload case</button>
