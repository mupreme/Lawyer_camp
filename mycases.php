				...
				<div class="d-flex" id="wrapper">
					...
					<div class="bg-light border-right" id="sidebar-wrapper">
						...
						<div class="list-group list-group-flush">
							...
							<a href="lawyer.php" class="list-group-item list-group-item-action bg-light">Lawyers</a><!--this page-->
							<a href="case.php" class="list-group-item list-group-item-action bg-light">Case</a><!--booking page-->
							<a href="user_profile.php" class="list-group-item list-group-item-action bg-light">Edit Profile</a><!--user_profile page-->
							<a href="user_booking.php" class="list-group-item list-group-item-action bg-light">My booking</a><!--booking page-->
									...
									<div class="widget-content">
										...
										<table class="table table-striped table-bordered  table-success table-responsive">
											...
											<?php
												...
												$conn = connect();
												$result = mysqli_query($conn,"SELECT fname,lname,description,cases.status as statuss
												FROM cases,lawyer,user 
												WHERE $row=lawyer_id=lawyer.lawyer_id 
												AND lawyer.lawyer_id=user.u_id 
												
												and cases.client_id='$a'
												");
												$counter = 0;
												...
												<tbody id="myTable">
													<tr>
														...
														<td><?php echo $row["description"]; ?> <?php echo $row["last_Name"]; ?></td>
