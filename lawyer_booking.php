												...
												<tbody id="myTable">
													<tr>
														...
														<?php if ($row['statuss']=='Pending'){ ?>
															<td>
																<a class="btn btn-sm btn-primary" href="lawyer_booking.php?unblock_id=<?=$row['booking_id']?>"><i class="fas fa-hourglass"></i>&nbsp; Pending</a>
															</td>
															<?php }
															else{?>
															<td>
																...
																<a class="btn btn-sm btn-warning" href="lawyer_booking.php?unblock_id=<?=$row['booking_id']?>"><i class="fa fa-check "></i>&nbsp; Approved</a>
