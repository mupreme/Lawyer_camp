									...
									<div class="widget-content">
										<div class="row">
											...
											<?php
												...
												<div class="col-md-10">
													<form  action="save_lawyer_edit_Profile.php"  method="post" enctype="multipart/form-data"  id="validateForm">
														...
														<div class="form-row"><label class="font-weight-bold" for="edu"><small>Put Your Last Education</small></label></div>
														<div class="form-row">
															<div class="form-group col-md-6">
														...
														<div class="form-row"><label class="font-weight-bold" for="edu"><small>Put Your cabinet Location </small></label></div>
														<div class="form-row">
															<div class="form-group col-md-6">
											...
											<input type="text" class="form-control" name="zip_code" id="zip_code" value="<?php echo $row["city"]; ?>">
														...
														<div class="form-group">
															<label class="font-weight-bold" for="practise">Length of practise</label>
