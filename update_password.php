										...
										<div class="basic-form">
											...
											<form autocomplete="off" method="post" action="update_password.php">				  
												<div class="form-group row">
													<label class="font-weight-bold" for="inputPassword" class="col-sm-3 col-form-label">Current Password</label>
												...
												<div class="form-group row">
													<label class="font-weight-bold" for="inputPassword" class="col-sm-3 col-form-label">New Password</label>
													<div class="col-sm-8">
												...
												<div class="form-group row">
													<label class="font-weight-bold" for="inputPassword" class="col-sm-3 col-form-label">Confirm Password</label>
													<div class="col-sm-8">
