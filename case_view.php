<?php
	...
	if($_SESSION['login']==TRUE AND $_SESSION['status']=='Active'){
		...
		if(isset($_GET['unblock_id'])){
			...
			$sql = "UPDATE `cases` SET `status`='Requested' WHERE case_id='$id'";
			//echo $sql;
			$conn->query($sql);
				...
				<div class="d-flex" id="wrapper">
					...
					<div class="bg-light border-right" id="sidebar-wrapper">
						...
						<div class="list-group list-group-flush">
							...
							<a href="case_view.php" class="list-group-item list-group-item-action bg-light"><i class="fa fa-cube" aria-hidden="true"></i>&nbsp;Cases</a><!--this page-->
							...
							<a href="update_password_admin.php" class="list-group-item list-group-item-action bg-light"><i class="fa fa-mouse-pointer"aria-hidden="true"></i>&nbsp;Password</a>
						</div>
					</div>
					<!-- /#sidebar-wrapper -->
									...
									<div class="widget-content">
										...
										<table class="table table-striped table-bordered table-responsive">
											...
											<?php
												...
												$conn = connect();
												$result = mysqli_query($conn,"SELECT case_id,fname,lname,contact,description,cases.status as 'statuss' FROM cases ");
												$counter = 0;
												...
												<tbody id="myTable">
													<tr>
														...
														<?php if ($row['statuss']=='Pending'){ ?>
															<td>
																<a class="btn btn-sm btn-primary" href="case_view.php?unblock_id=<?=$row['case_id']?>"><i class="fas fa-inbox"></i>&nbsp; Request</a>
															</td>
															<?php }
															else{?>
															<td>
