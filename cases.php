	...
	<body>
		...
		<body>
			...
			<section class="">
					...
					<div class="container">
					<br/>
					<a href="searchcase.php"type="submit" class="btn btn-md btn-primary "><i class="fa fa-search"></i>&nbsp; Find Cases</a> <h2 style="float:right;">Related cases copy</h2>
					<hr/>
						<div class="row " >
							...
							<?php
								...
								$result = mysqli_query($conn,"SELECT * FROM cases");
								...
								<div class="col-md-3">
									<div class="card" style="width: 15rem;">
										...
										<div class="card-body">
											<!-- <h5 class="card-title"><b>Category:</b> <?php echo $row["Category"]; ?> </h5> lawyers name dynamic -->
											<h6 class="card-title"><b>Details:</b> <?php echo $row["description"]; ?>...<a href="#">more details&nbsp;&nbsp;<i class="fa fa-angle-double-down"></i></a></h6> <!--lawyers practice speciality dynamic-->
											  <!--lawyers practice time dynamic-->
											
											<!-- <a class="btn btn-sm btn-primary" href="https://iecms.gov.rw/en/"><i class="fa fa-cube"></i>&nbsp; Buy</a> -->
										</div>
									</div>
								</div>
								<?php
