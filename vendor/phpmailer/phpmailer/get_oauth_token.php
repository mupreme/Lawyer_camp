...
<form method="post">
    ...
    <label class="font-weight-bold" for="providerGoogle">Google</label><br>
    <input type="radio" name="provider" value="Yahoo" id="providerYahoo">
    <label class="font-weight-bold" for="providerYahoo">Yahoo</label><br>
    <input type="radio" name="provider" value="Microsoft" id="providerMicrosoft">
    <label class="font-weight-bold" for="providerMicrosoft">Microsoft</label><br>
